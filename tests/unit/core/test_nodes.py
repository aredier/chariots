"""module that tests the node's behaviors"""
import json
import os
...
def test_data_loading_node(tmpdir):
    """test that `DataLoadingNode` class"""
...
def test_data_saving_node(tmpdir):
    """test the `DataSavingnNode` class"""
