...
class BaseOp(metaclass=versioning.VersionableMeta):  # pylint: disable=no-member
    """
    ...
    def __init__(self, op_callbacks: Optional[List[callbacks.OpCallBack]] = None):
    ...
    @property
    def op_version(self) -> versioning.Version:
        """
